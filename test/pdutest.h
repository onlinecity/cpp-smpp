...
public:
    ...
    void testBinary() {
        ...
        uint8_t testdata[] = {
                0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x74, 0x65, 0x73, 0x74, 0x00,
                0xde, 0xad, 0xbe, 0xef, 0x13, 0x37, 0x80 };
...
CPPUNIT_TEST_SUITE(PduTest);
    ...
    CPPUNIT_TEST(testBinary);CPPUNIT_TEST_SUITE_END()
    ;
};
